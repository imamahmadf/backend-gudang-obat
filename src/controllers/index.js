const obatControllers = require("./obatControllers");
const noBatchControllers = require("./noBatchControllers");
...
const statistikControllers = require("./statistikControllers");
module.exports = {
  obatControllers,
  noBatchControllers,
  userControllers,
